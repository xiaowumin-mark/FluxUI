...
func buildDocsMaterial3Showcase(th *ui.Theme) ui.Element {
	...
	return ui.ColumnElement(
		...
		ui.VSpacerElement(8),
		ui.TextElement("Theme tokens, seeded color roles, component variants, state layers, shape and typography are available through the React-style Element API.", ui.TextType(th.Types.BodySmall), ui.TextColor(th.Colors.OnSurfaceVariant)),
		ui.VSpacerElement(12),
		ui.RowElement(
			ui.ExpandedElement(material3TokenCard("Primary", th.Colors.Primary, th.Colors.OnPrimary, th)),
			ui.HSpacerElement(8),
			ui.ExpandedElement(material3TokenCard("Secondary", th.Colors.Secondary, th.Colors.OnSecondary, th)),
			ui.HSpacerElement(8),
		...
		ui.ContainerDecorationElement(
			...
			ui.ColumnElement(
				ui.TextElement("Button variants", ui.TextType(th.Types.LabelLarge), ui.TextColor(th.Colors.OnSurface)),
				ui.VSpacerElement(8),
				ui.RowElement(
		...
		ui.VSpacerElement(12),
		ui.RowElement(
			ui.ExpandedElement(material3ComponentCard("Filled card", "SurfaceContainer roles and MD3 shapes.", ui.FilledCardElement, th)),
			ui.HSpacerElement(10),
			ui.ExpandedElement(material3ComponentCard("Elevated card", "Elevation and state layers stay token-driven.", ui.ElevatedCardElement, th)),
			ui.HSpacerElement(10),
			ui.ExpandedElement(material3ComponentCard("Outlined card", "OutlineVariant and corners are theme aware.", ui.OutlinedCardElement, th)),
		),
		ui.VSpacerElement(12),
		ui.RowElement(
			ui.FilterChipElement("Selected chip", ui.ChipSelected(true)),
			ui.HSpacerElement(8),
